...
<head>
	...
	<title>KOMITJAWA :: Administrator Login ::</title>
...
<body>
	...
	<div id="wrapper">
		...
		<!-- <br><br><p align="center" style="font-size: 15px; font-weight: bold;"> JAPO <BR> KOMITJAWA</p>-->
		<?php
		if ($_GET['code'] == 1){
		?>
		...
		<div id="wrappermiddle">
			...
			<div id="password_input">
				...
				<p><input type="checkbox" name="dosen" value="1"> Kotak Umum</p>
			</div>
			<br>
			<div id="submit">
		...
		<div id="powered">
		<p>Copyright &copy; <?php echo date('Y'); ?> W-Soft </p>
		</div>
	</div>
